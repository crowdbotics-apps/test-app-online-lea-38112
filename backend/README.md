...
## Project Structure
    ...
    ├── test_app_online_lea_38112  # Django project configurations
...
1. Clone this repo and `cd test_app_online_lea_38112`
...
2. Clone this repo and `cd test_app_online_lea_38112`
